...
namespace _123.Models
{
	...
	public partial class QLBanxeganmayDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertHANGSANXUAT1(HANGSANXUAT1 instance);
    partial void UpdateHANGSANXUAT1(HANGSANXUAT1 instance);
    partial void DeleteHANGSANXUAT1(HANGSANXUAT1 instance);
    ...
    partial void DeleteAdmin(Admin instance);
		...
		public QLBanxeganmayDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLBanxeganmayDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLBanxeganmayDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public QLBanxeganmayDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<HANGSANXUAT1> HANGSANXUAT1s
		{
			get
			{
				return this.GetTable<HANGSANXUAT1>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HANGSANXUAT")]
	public partial class HANGSANXUAT1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDienthoaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HANGSANXUAT1_SANXUATXE", Storage="_SANXUATXEs", ThisKey="MaHSX", OtherKey="MaHSX")]
		public EntitySet<SANXUATXE> SANXUATXEs
		{
			get
			{
	...
	public partial class SANXUATXE : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<HANGSANXUAT1> _HANGSANXUAT1;
    ...
    partial void OnSoLuongChanged();
		...
		public SANXUATXE()
		{
			...
			this._HANGSANXUAT1 = default(EntityRef<HANGSANXUAT1>);
			this._XEGANMAY = default(EntityRef<XEGANMAY>);
			OnCreated();
		}
		...
		public int MaHSX
		{
			...
			set
			{
				if ((this._MaHSX != value))
				{
					if ((this._HANGSANXUAT.HasLoadedOrAssignedValue || this._HANGSANXUAT1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnMaHSXChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HANGSANXUAT1_SANXUATXE", Storage="_HANGSANXUAT1", ThisKey="MaHSX", OtherKey="MaHSX", IsForeignKey=true)]
		public HANGSANXUAT1 HANGSANXUAT1
		{
			get
			{
			...
			set
			{
				HANGSANXUAT1 previousValue = this._HANGSANXUAT1.Entity;
				if (((previousValue != value) 
